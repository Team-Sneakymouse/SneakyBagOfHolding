...
object CategoryMenuLayout {
    ...
    fun isNavigationSlot(slot: Int): Boolean = slot == GAP_SLOT || slot == PREV_TAB_SLOT ||
        slot == BACK_SLOT || slot == NEXT_TAB_SLOT
